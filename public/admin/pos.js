...
const posMain = async (auth, user) => {
    ...
    const loadInitialData = async () => {
        ...
        menuCategories = []; // Reset categories
    ...
    const calculateTotals = () => {
        ...
        const total = taxExclusiveTotal + taxAmount;
    ...
    const checkUrlParams = async () => {
        ...
        try {
            const bookingDoc = await getDoc(doc(db, "reservations", bookingId));
    ...
    [discountValueInput, discountTypeSelect, lengthFeeSelect].forEach(el => {
