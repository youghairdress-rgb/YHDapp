        ...
        customers.forEach(customer => {
            ...
            card.innerHTML = `
                ...
                <div class="customer-card-actions">
                    <button class="icon-button counseling-btn" title="AIカウンセリング" data-customer-id="${customer.id}"><i class="fa-solid fa-address-card"></i></button>
            ...
            card.querySelector('.counseling-btn').addEventListener('click', (e) => {
                e.stopPropagation();
                const customerId = e.currentTarget.dataset.customerId;
                
                const counselingUrl = new URL('./counseling/index.html', window.location.href).href;

                liff.openWindow({
                    url: `${counselingUrl}?customerId=${customerId}`
                });
            });
